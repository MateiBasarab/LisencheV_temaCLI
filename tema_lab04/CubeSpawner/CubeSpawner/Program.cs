...
namespace CubeSpawner
{
    public class Game : GameWindow
    {
        ...
        public Game() : base(800, 600, GraphicsMode.Default, "CubeSpawner")
        {
            VSync = VSyncMode.On;
        }
        ...
        private void HELP()
        {
            ...
            Console.WriteLine("   LMB - Creeaza cub");
            Console.WriteLine("   RMB - Sterge toate cuburile create\n");

            Console.WriteLine("[WASD] - Schimbare pozitie camera\n");
        ...
        {
            cubes.Clear();
            Console.WriteLine("Stergerea s-a realizat cu succes!");
        }
